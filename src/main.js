...
import { CanvasEngine } from './canvas-engine.js?v=20260710h';
import { CursorLayer } from './cursor-layer.js?v=20260710h';
import { ExportManager } from './export.js?v=20260710h';
import { yjsSync } from './yjs-sync.js?v=20260710h';
...
async function initMapLayer() {
  try {
    const { MapLayer } = await import('./map-layer.js?v=20260710h');
