...
import { CanvasEngine } from './canvas-engine.js?v=20260710i';
import { CursorLayer } from './cursor-layer.js?v=20260710i';
import { ExportManager } from './export.js?v=20260710i';
import { yjsSync } from './yjs-sync.js?v=20260710i';
...
async function initMapLayer() {
  try {
    const { MapLayer } = await import('./map-layer.js?v=20260710i');
