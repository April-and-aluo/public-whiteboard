...
import { CanvasEngine } from './canvas-engine.js?v=20260710g';
import { CursorLayer } from './cursor-layer.js?v=20260710g';
import { ExportManager } from './export.js?v=20260710g';
import { yjsSync } from './yjs-sync.js?v=20260710g';
...
async function initMapLayer() {
  try {
    const { MapLayer } = await import('./map-layer.js?v=20260710g');
